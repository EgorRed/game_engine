...
void glfwWindowSizeCallback(GLFWwindow* pWindow, int width, int height)
{
    ...
    std::cout << g_windowSizeX << " : " << g_windowSizeY << std::endl;
}
...
int main(int argc, char** argv)
{
	...
	if(!gladLoadGL())
	{
		std::cout << "can't load GLOD!" << std::endl;
		return -1;
	}
